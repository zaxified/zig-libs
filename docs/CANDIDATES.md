...
- ✅ **`encoding`** DONE 2026-07-09 — legacy single-byte European code pages (windows-1250/1252, iso-8859-1/2/15) ↔ UTF-8, std-only, data-lenient. Broader WHATWG/CJK coverage is **out of scope, not planned** (no in-house need). Seed: bxp encoding.zig. **Decision:** shipped (European subset = final scope).
