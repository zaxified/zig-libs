...
Built: zig-out/bin/ssh-demo

  ./zig-out/bin/ssh-demo server --port 2222     # run the server side
  ./zig-out/bin/ssh-demo client --port 2222     # and, in another shell, the client
