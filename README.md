...
| [`qrscan`](modules/qrscan/README.md) | Locate a QR symbol in a grayscale image (luma + stride, camera or canvas) at any rotation and sample it into a `qr.Matrix`; block-adaptive binarisation, allocation-free. | any | qr |
