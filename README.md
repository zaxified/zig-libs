...
**Status:** 40 modules · 1084 tests (Zig 0.16, green in Debug + ReleaseFast) · **MIT** (see `LICENSE`;
...
| `jwt` | JWT/JWS validator (RFC 7515/7519) — compact parse + claims validation _(signature verify + JWKS + OIDC: in progress)_ | — |
