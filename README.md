...
**Status:** 44 modules · 1190 tests (Zig 0.16, green in Debug + ReleaseFast) · **MIT** (see `LICENSE`;
...
| `coap` | CoAP (RFC 7252) message codec — header/token/**delta-encoded options**/payload parse + serialize, zero-alloc, transport-agnostic (options registry + reliability + client/server are follow-ups) | any | — |
