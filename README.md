...
| [`zstd`](modules/zstd/README.md) *(format)* | Zstandard (RFC 8878) compressor, levels 1-22 and negative levels — byte-identical to libzstd 1.5.7 `ZSTD_compress2` and `ZSTD_compressStream2` — and a one-shot decoder ported from libzstd's (checksums, concatenated and skippable frames, frame queries) | any | — |
...
| [`zstd`](modules/zstd/README.md) | Zstandard (RFC 8878) compressor, levels 1-22 and negative levels — byte-identical to libzstd 1.5.7 `ZSTD_compress2` and `ZSTD_compressStream2` — and a one-shot decoder ported from libzstd's (checksums, concatenated and skippable frames, frame queries) | any | — |
