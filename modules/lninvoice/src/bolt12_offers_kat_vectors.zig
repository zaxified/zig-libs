...
// Generated mechanically from lightning/bolts `bolt12/offers-test.json` -- see
// modules/lninvoice/NOTICE for the required CC-BY 4.0 attribution. Do not
// hand-edit the vector bodies below; regenerate instead if the upstream file
// changes.
//!
//! All 53 rows of the upstream file are transcribed verbatim, including the
//! ones this module's decoder does not exercise (blinded-path internals,
//! UTF-8 validation, reader-policy semantic checks) -- `bolt12.zig`'s own tests
//! decide, vector by vector, which are in scope; skipped ones are documented
//! there, not silently dropped here.

pub const Field = struct { type: u64, hex: []const u8 };
...
pub const vectors = [_]Vector{
    .{
        ...
        .fields = &.{
            .{ .type = 22, .hex = "02eec7245d6b7d2ccb30380bfbe2a3648cd7a942653f5aa340edcea1f283686619" },
        },
    },
    .{
        ...
        .fields = &.{
            .{ .type = 10, .hex = "5465737420766563746f7273" },
            .{ .type = 22, .hex = "02eec7245d6b7d2ccb30380bfbe2a3648cd7a942653f5aa340edcea1f283686619" },
        },
    },
    .{
        ...
        .fields = &.{
            .{ .type = 2, .hex = "43497fd7f826957108f4a30fd9cec3aeba79972084e90ead01ea330900000000" },
            .{ .type = 10, .hex = "5465737420766563746f7273" },
            .{ .type = 22, .hex = "02eec7245d6b7d2ccb30380bfbe2a3648cd7a942653f5aa340edcea1f283686619" },
        },
    },
    .{
        ...
        .fields = &.{
            .{ .type = 2, .hex = "6fe28c0ab6f1b372c1a6a246ae63f74f931e8365e15a089c68d6190000000000" },
            .{ .type = 10, .hex = "5465737420766563746f7273" },
            .{ .type = 22, .hex = "02eec7245d6b7d2ccb30380bfbe2a3648cd7a942653f5aa340edcea1f283686619" },
        },
    },
    .{
        ...
        .fields = &.{
            .{ .type = 2, .hex = "1466275836220db2944ca059a3a10ef6fd2ea684b0688d2c379296888a2060036fe28c0ab6f1b372c1a6a246ae63f74f931e8365e15a089c68d6190000000000" },
            .{ .type = 10, .hex = "5465737420766563746f7273" },
            .{ .type = 22, .hex = "02eec7245d6b7d2ccb30380bfbe2a3648cd7a942653f5aa340edcea1f283686619" },
        },
    },
    .{
        ...
        .fields = &.{
            .{ .type = 4, .hex = "00000000000000000000000000000000" },
            .{ .type = 10, .hex = "5465737420766563746f7273" },
            .{ .type = 22, .hex = "02eec7245d6b7d2ccb30380bfbe2a3648cd7a942653f5aa340edcea1f283686619" },
        },
    },
    ...
    .{
        ...
        .fields = &.{
            .{ .type = 10, .hex = "5465737420766563746f7273" },
            .{ .type = 18, .hex = "68747470733a2f2f626f6c7431322e6f726720424f4c54313220696e6475737472696573" },
            .{ .type = 22, .hex = "02eec7245d6b7d2ccb30380bfbe2a3648cd7a942653f5aa340edcea1f283686619" },
        },
    },
    .{
    ...
    .{
        ...
        .fields = &.{
            .{ .type = 10, .hex = "5465737420766563746f7273" },
            .{ .type = 12, .hex = "08000000000000000000000000" },
            .{ .type = 22, .hex = "02eec7245d6b7d2ccb30380bfbe2a3648cd7a942653f5aa340edcea1f283686619" },
        },
    },
    .{
        ...
        .fields = &.{
            .{ .type = 10, .hex = "5465737420766563746f7273" },
            .{ .type = 16, .hex = "" },
            .{ .type = 22, .hex = "02eec7245d6b7d2ccb30380bfbe2a3648cd7a942653f5aa340edcea1f283686619" },
        },
    },
    .{
        ...
        .fields = &.{
            .{ .type = 10, .hex = "5465737420766563746f7273" },
            .{ .type = 16, .hex = "" },
            .{ .type = 22, .hex = "02eec7245d6b7d2ccb30380bfbe2a3648cd7a942653f5aa340edcea1f283686619" },
        },
    },
    .{
    ...
    .{
        ...
        .fields = &.{
            .{ .type = 10, .hex = "5465737420766563746f7273" },
            .{ .type = 16, .hex = "" },
            .{ .type = 22, .hex = "02eec7245d6b7d2ccb30380bfbe2a3648cd7a942653f5aa340edcea1f283686619" },
        },
    },
    .{
        ...
        .fields = &.{
            .{ .type = 10, .hex = "5465737420766563746f7273" },
            .{ .type = 22, .hex = "02eec7245d6b7d2ccb30380bfbe2a3648cd7a942653f5aa340edcea1f283686619" },
            .{ .type = 33, .hex = "68656c6c6f776f726c64" },
        },
    },
    .{
        ...
        .fields = &.{
            .{ .type = 10, .hex = "5465737420766563746f7273" },
            .{ .type = 22, .hex = "02eec7245d6b7d2ccb30380bfbe2a3648cd7a942653f5aa340edcea1f283686619" },
            .{ .type = 1000000033, .hex = "68656c6c6f776f726c64" },
        },
    },
    .{
    ...
    .{
        ...
        .fields = &.{
            .{ .type = 8, .hex = "" },
            .{ .type = 10, .hex = "" },
            .{ .type = 22, .hex = "035be5e9478209674a96e60f1f037f6176540fd001fa1d64694770c56a7709c42c" },
        },
    },
    .{
