...
pub const meta = .{
    ...
    .doc = "IS-IS flooding transmit scheduler — drains `isis-lsdb` SRM/SSN flags into ordered PDUs to send, paces LSP (re)transmission + periodic CSNPs; pure time-injected",
