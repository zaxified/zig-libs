...
//! same value `bip32.ckdPriv`/`ckdPub` take.
...
pub const TestVector = struct {
    ...
    master_xpub: []const u8,
    chain: []const ChainStep,
};

pub const test_vector_1 = TestVector{
...
pub const test_vector_2 = TestVector{
    ...
    .master_xprv = "xprv9s21ZrQH143K31xYSDQpPDxsXRTUcvj2iNHm5NUtrGiGG5e2DtALGdso3pGz6ssrdK4PFmM8NSpSBHNqPqm55Qn3LqFtT2emdEXVYsCzC2U",
    .master_xpub = "xpub661MyMwAqRbcFW31YEwpkMuc5THy2PSt5bDMsktWQcFF8syAmRUapSCGu8ED9W6oDMSgv6Zz8idoc4a6mr8BDzTJY47LJhkJ8UB7WEGuduB",
    .chain = &.{
        .{
            .index = 0,
        ...
        .{
            .index = hardened_offset + 2147483647,
        ...
        .{
            .index = hardened_offset + 2147483646,
...
// Vector 3: leading-zero-key retention (a privkey/IL whose serialization
// would drop leading zero bytes if not fixed-width-padded).
pub const test_vector_3 = TestVector{
    ...
    .master_xprv = "xprv9s21ZrQH143K25QhxbucbDDuQ4naNntJRi4KUfWT7xo4EKsHt2QJDu7KXp1A3u7Bi1j8ph3EGsZ9Xvz9dGuVrtHHs7pXeTzjuxBrCmmhgC6",
    .master_xpub = "xpub661MyMwAqRbcEZVB4dScxMAdx6d4nFc9nvyvH3v4gJL378CSRZiYmhRoP7mBy6gSPSCYk6SzXPTf3ND1cZAceL7SfJ1Z3GC8vBgp2epUt13",
    .chain = &.{
        .{
            .index = hardened_offset + 0,
...
/// Vector 5: invalid extended keys that must be rejected. `reason` documents
/// which check should trip (comments carried from the BIP-32 spec table);
/// this implementation is not required to distinguish the exact reason, only
/// to reject every one of them.
pub const invalid_vector_5 = [_][]const u8{
    ...
    "xpub661MyMwAqRbcEYS8w7XLSVeEsBXy79zSzH1J8vCdxAZningWLdN3zgtU6Q5JXayek4PRsn35jii4veMimro1xefsM58PgBMrvdYre8QyULY", // invalid pubkey (not on curve)
