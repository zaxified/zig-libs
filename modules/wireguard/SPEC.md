...
use in the whole repo (zig-libs is otherwise 100% pure-Zig/no-exec). Flagged in PLAN.md for the
pure-Zig-invariant audit: either replace with a direct rtnetlink `RTM_NEWLINK`/`IFLA_LINKINFO` call
