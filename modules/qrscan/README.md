...
family documents, from that description rather than its source. No test data
is committed: the image corpus for the zxing-cpp differential in `tools/` is
generated by our own tooling at run time. See [`SPEC.md`](SPEC.md).
