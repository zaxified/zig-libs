...
pub const Fp6 = struct {
    ...
    /// recomputed per call (~2 fixed-exponent `Fp2.pow`s) — trivially
    /// cheap for Part 1's callers; caching them is a Part-2 (pairing
    /// hot path) optimization, noted in SPEC.md's Backlog.
