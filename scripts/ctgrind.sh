...
declare -A LABEL=(
    ...
    [hqc/decaps]='hqc decaps (spec rejection loop)'
    [hqc/keygen]='hqc keygen (spec rejection loop)'
    [hqc/encaps]='hqc encaps (clean)'
    [hqc/sampler]='hqc prng (spec rejection loop)'
    ...
    [fss/eval]='fss eval (key; masked descent)'
